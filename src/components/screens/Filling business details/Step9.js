        ...
        <div>
            ...
            <div className="bg-white w-[100%] m-auto mb-[5%] p-4 text-left justify-start">
                <div className="flex items-center justify-start">
                    <h1 className="text-[18px] mx-2 cursor-pointer">Aadhaar Authentication</h1>
                </div><hr/>
                
                <div className="bg-gray-100 mt-2 p-4 flex justify-start">
                    <h1 className="text-[16px]">Do you want to otp for Aadhaar Authentication of details of Promoter/Partners, Primary Authorized Signatory added by you?<span className="text-red-600">*</span></h1>
                </div>
                
                <div className="p-4 flex justify-start">
                    <ol className="text-[14px] list-decimal pl-4">
