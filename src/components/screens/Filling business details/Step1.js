...
const Step1 = () => {
    return (
        <div>
            ...
            <p className="bg-slate-100 w-full p-2 text-left"> <span className="text-blue-600">Dashboard</span> <ion-icon name="chevron-forward-outline"></ion-icon> Business Details</p>
            ...
            <div className="bg-white w-[100%] m-auto mb-[5%] p-4 text-left justify-start">
                ...
                <form className="mt-4">
                    ...
                    <div className="bg-gray-100 mt-4 p-4">
                        <p className="header-text">Are you applying for registration as a casual <br/> Taxable person? <ion-icon name="alert-circle" class=""></ion-icon></p>
                    ...
                    <div className="mt-4">
                        ...
                        <div className="bg-gray-100 mt-4 p-4 flex justify-between">
                            <div>
                                <label htmlFor="tradeName" className="header-text py-1">Type of Registration <span className="text-red-600">*</span></label><br/>
                                <select className="w-[200px] my-1 p-2 border border-black">
                                    <option>Select</option>
                                    <option>GSTIN</option>
