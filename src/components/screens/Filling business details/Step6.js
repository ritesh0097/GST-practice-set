        ...
        <div>
            ...
            <div className="bg-white w-[100%] m-auto mb-[5%] p-4 text-left justify-start">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl">Details of Additional Places of your Business</h1>                    
                </div><hr/>

                <div className="bg-orange-100 mt-4 p-4">
                    <h1 className="font-bold"><ion-icon name="information-circle"></ion-icon>Important! If you need to add details on additional places of business:</h1>
                    <p>1. Go to <b>Principal Place of Business tab.</b></p>
                    <p>2. Select <b>Yes</b> for <b>Have Additional Places of Business</b></p>
                </div>
                ...
                <div className="mt-12 flex justify-end items-center">
                    ...
                    <Link to={"/goods and serivces/goods"}><div className="bg-blue-900 text-white px-8 py-2 mx-2 font-bold border border-black flex items-center cursor-pointer hover:bg-blue-500">SAVE & CONTINUE</div></Link>
                </div>
                </div>
