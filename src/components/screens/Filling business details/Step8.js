        ...
        <div>
            ...
            <div className="bg-white w-[100%] m-auto mb-[5%] p-4 text-left justify-start">
                <div className="flex items-center justify-start">
                    <h1 className="text-[18px] mx-2 cursor-pointer">State Specific Information</h1>
                </div><hr/>
                
                <div className="bg-gray-100 mt-2 p-4 flex justify-start">
                    <div>
                        <label htmlFor="tradeName" className="">Professional Tax Employee Code (EC) No. </label><br/>
                        <input type="text" id="tradeName" placeholder="Enter Professional Tax E.C Number" required className="w-[450px] my-1 p-2 border border-black" />
                    </div>
                    <div className="mx-12"></div>
                    <div>
                        <label htmlFor="panNumber" className="py-1">Professinal Tax Registration Certificate (RC) No.</label><br/>
                        <input type="text" id="panNumber" placeholder="Enter Professional Tax RC Number" required className="w-[450px] my-1 p-2 border border-black" />
                    </div>
                </div>
                
                <div className="mt-2 p-4 flex justify-start">
                    <div>
                        <label htmlFor="tradeName" className="">State Excise License No.</label><br/>
                        <input type="text" id="tradeName" placeholder="Enter State Excise License Number" required className="w-[450px] my-1 p-2 border border-black" />
                    </div>
                    <div className="mx-12"></div>
                    <div>
                        <label htmlFor="panNumber" className="py-1">Name of the person in whose name Excise License is held</label><br/>
                        <input type="text" id="panNumber" placeholder="Enter Name of the Person in whose name Excise License is held" required className="w-[450px] my-1 p-2 border border-black" />
                    </div>
                </div>
