    ...
    return (
        <div>
            ...
            <div className="bg-white w-[100%] m-auto mb-[5%] p-4 text-left justify-start">
                <div className="">
                    <h1 className="header-text"><span className="text-green-800 text-xl"><ion-icon name="checkmark-circle-sharp"></ion-icon></span> Success</h1>                    
                </div><hr/>
                
                <div className="mt-2 p-4 mb-[300px]">
                    <h1 className="header-text">Thank you for submission</h1>
