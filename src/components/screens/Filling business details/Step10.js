...
const Step10 = () => {
    ...
    return (
        <div>
            ...
            <p className="bg-slate-100 w-full p-2 text-left"> <span className="text-blue-600">Dashboard</span> <ion-icon name="chevron-forward-outline"></ion-icon> Verification</p>
            ...
            <div className="flex items-center justify-between">
                    <h1 className="header-text"><ion-icon name="thumbs-up-sharp"></ion-icon> Verification</h1>
