        ...
        <div>
            ...
            <div className="bg-white w-[100%] m-auto mb-[5%] p-4 text-left justify-start">
                <div className="flex items-center justify-start">
                    <Link to={"/goods and serivces/goods"}><h1 className="text-[18px] mx-2 cursor-pointer border-b-2 border-indigo-500 ">Goods</h1></Link>
                    <Link to={"/goods and serivces/services"}><h1 className="text-[18px] mx-2 cursor-pointer">Services</h1></Link>
                </div><hr/>
                
                <div className="flex items-center justify-start">
                    <h1 className="text-[20px] mx-2 mt-4">Details of Goods / Commodities by the business</h1>
                </div><hr/>
                
                <div className="flex items-center justify-start">
                    <h1 className="text-[18px] mx-2 mt-4">Please specifiy top 5 Commodities</h1>
                </div><hr/>
                
                <div className="p-2">
                    <h1 className="text-[18px] mx-2 mt-8">Search HSN Chapter by Name or Code</h1>                    
